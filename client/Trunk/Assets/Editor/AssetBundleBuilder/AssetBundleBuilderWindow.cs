...
namespace Assets.Editor.AssetBundleBuilder
{
    class AssetBundleBuilderWindow : EditorWindow
    {
        ...
        {
            instance = (AssetBundleBuilderWindow)EditorWindow.GetWindow(typeof(AssetBundleBuilderWindow));
            instance.Init();
        }
        ...
        void OnGUI()
        {
            ...
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.TextField("Load Path", _config.LoadPath);
            ...
            EditorGUILayout.EndHorizontal();
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.TextField("Export Path", _config.ExportPath);
            if (GUILayout.Button("Select"))
            {
