...
namespace RedDragon.Protocol
{
  ...
  [Serializable]
  #endif
  public partial class CsPlayerUpdateMoveDir : TBase
  {
    ...
    public CsPlayerUpdateMoveDir(PosInfo posInfo, double time) : this() {
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("CsPlayerUpdateMoveDir");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("CsPlayerUpdateMoveDir(");
      __sb.Append(", PosInfo: ");
